export let productsOption = [
    ...
    [1600,	1601,	4,	599,	0,	'Iphone  Sto[rage, capa,city 64 GB '],
    [1600,	1602,	7,	699,	1,	'Iphone  Sto[rage, capa,city 128 GB'],
    ...
    [1800,	1802,	10, 599,	1,	'Ipad Mini 10-inch (diagonal) LED-backlit Multi-Touch display with IPS technology'],
    [1900,	1901,	4,	650,	1,	'ESC4000 G3 Server with 2U 4-GPU Hybrid Computing Power with Mass Storage Capability'],
    [1900,	1902,	6,	750,	0,	'ESC8000 G4 Server with High-density 4U GPU server support  GPU 8s'],
    ...
    [2200,	2202,	50,	700,	1,	'Dell Inspiron 24 PC with 23.-in [Full, HD. ,Intel Core i5-7200U. 8GB memory/1TB SATA'],
